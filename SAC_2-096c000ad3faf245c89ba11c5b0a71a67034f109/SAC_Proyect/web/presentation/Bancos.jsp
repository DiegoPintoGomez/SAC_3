...
<html lang="es">
    ...
    <body>
        ...
        <div class="container container-fluid" id="containerCrearEncuesta" style="height: 500px ">
            ...
            <table id="example" class="table table-bordered table-striped mb-0 " style=" height: available; position: relative; width:400; margin-top: 0px;  margin-left: 0px; margin-right: 0px;">
